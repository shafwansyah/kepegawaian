<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('dashboard_admin') }}">
        <div class="sidebar-brand-icon d-none d-md-block">
            <img src="{{ asset('asset/img/iclogo-white.png') }}" alt="">
        </div>
        <div class="sidebar-brand-icon d-block d-md-none">
            <img src="{{ asset('asset/img/icbulat.png') }}" alt="" style="width: 60px">
        </div>
    </a>
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{ route('role') }}">Data Role Pegawai</a>
                <a class="collapse-item" href="{{ route('divisi.index') }}">Data Divisi Pegawai</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{ route('absen.index') }}">Rekapan Absen</a>
