...
@section('title') Admin || Divisi @endsection
        ...
        <div class="col-lg-12 mb-4">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Data Divisi Divisi</h6>
                </div>
                <div class="d-none d-sm-none d-md-block m-3">
                    <a href="{{ route('divisi.create') }}" class="btn btn-sm btn-primary shadow-sm">
                        <i class="fas fa-user-plus fa-sm text-white-50"></i> Tambah Divisi
                    </a>
